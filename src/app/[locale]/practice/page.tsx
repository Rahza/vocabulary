...
export default function PracticePage() {
  ...
  const [view, setView] = useState<'mode-selection' | 'config' | 'practice' | 'summary'>(
    'mode-selection'
  );
  ...
  return (
    <motion.div variants={containerReveal} initial="hidden" animate="visible" className="space-y-8">
      <motion.div variants={itemReveal}>
        <Heading
          level={1}
          subtitle={view === 'mode-selection' ? t('selectMethod') : t('thematicTraining')}
        >
          {t('title')}
        </Heading>
      </motion.div>
          ...
          >
            <div className="flex justify-between items-center px-2">
              <div className="flex flex-col">
                ...
                <span className="text-sm font-black text-playful-indigo">
