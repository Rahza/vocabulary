  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-4">
        ...
        <motion.div variants={itemReveal}>
          <Card className="bg-playful-green text-white p-6 text-center border-none shadow-playful">
      ...
      <motion.div variants={itemReveal}>
        <Card className="p-0 overflow-hidden">
          ...
          <div className="divide-y-2 divide-zinc-50 dark:divide-zinc-800">
            {stats.length === 0 ? (
              <div className="p-8 text-sm text-zinc-500 text-center font-medium">
                {t('noThemes')}
              </div>
            ) : (
              stats.map((stat) => (
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <span className="text-xs text-zinc-400 block font-semibold">
                        {stat.totalWords} {t('totalCardsLabel')}
                      </span>
                    </div>
