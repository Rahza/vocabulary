...
**Rationale**: The "blank screen" bug occurs because the component logic likely switches based on the _existence_ of results but doesn't correctly re-mount or reset the form visibility after results are cleared (save/discard).
