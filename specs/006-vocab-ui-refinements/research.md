...
- _Horizontal grid (2 columns)_: Rejected because German/Czech word pairs can be long and require full width for readability on mobile.
...
- _Inline expansion (Accordion)_: Rejected as it pushes following items down, which is disorienting in a large list.
...
- _Standard HTML checkbox_: Rejected as it doesn't match the "playful" design system (large radii, custom colors).
