...
- **A**: The migration assumes the existing data _was_ German/Czech. We will default the `UserSettings` to Source=German, Target=Czech if not already set, to preserve the context of the existing data.
