# Data Model: UI Refinements

This document defines the static mappings used for UI enhancements.
...
- `index`: Number (1-5)
- `name`: String (e.g., "Keimling")
- `icon`: String (Emoji or Icon name)
- `description`: String (Context for the learning stage)
