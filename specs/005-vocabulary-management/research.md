...
- *IndexedDB with search index*: Overkill for this scale; LocalStorage JSON parsing is fast enough.
- *Server-side search*: N/A as this is a local-first application.
...
**Alternatives Considered**: 
- *Right-click context menu*: Less discoverable and harder to implement for touch devices.
...
**Alternatives Considered**: 
- *Normalized Tag Table*: Would require significant refactoring of the current data model. Linear scan is simpler and sufficient for the MVP.
